    ...
    <div class="container-fluid" style="border-radius:5px;height:100vh;padding:0;">
        <div class="mynav">
            <div class="container" id="menu-container">
                <ul>
                    <li id="close-menu-btn" style="display: none;"><a href="#" onclick="closeMenu()"
                            style="font-size:20px;">&times;</a></li>
                    ...
                    <li><a class="@if (isset($active) && $active == 'configuration') active @else inactive @endif" href="{{ route('site.configuration') }}">پیکربندی
                            دستگاه</a>
                    </li>
